...
function helloworld_setup() {
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'helloworld' ),
	) );
...
function helloworld_scripts() {
	...
	wp_enqueue_script( 'helloworld-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'helloworld-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
